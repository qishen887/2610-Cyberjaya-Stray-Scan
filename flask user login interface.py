...
# --- Mock Database ---
# Note: The passwords here look messy because they are generated by generate_password_hash
# Administrator original password: admin123
# Ordinary user original password: user123
users = {
    "admin@example.com": {
